...
<html>
   ...
   <head>
      <title>Insert Record in Departments Table</title>
   ...
   <div align="center">
      ...
      <?php
		...
		require("public_html/tableshow.php");
         ...
         if(isset($_POST['add'])) {
			...
			echo " <br> Departments table before insertion <br>";
			...
			echo " <br> Departments table after insertion <br>";
			show_departments($conn);
      ...
      ?>
	  <br><br><br><br>
     <p>Enter Departments information for insertion <br> </p>
